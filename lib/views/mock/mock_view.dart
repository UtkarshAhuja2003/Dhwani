...
class DhwaniMockView extends StatefulWidget {
  const DhwaniMockView({super.key});

  @override
  State<DhwaniMockView> createState() => _DhwaniMockView();
}

class _DhwaniMockView extends State<DhwaniMockView> {
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              DhwaniMockScreen(dhwani: dhwaniData, alphabets: dhwani.dhwanis, mockType: 'categorised')));
                                },
                                child: Column(
                                  children: [
                                    Padding(
